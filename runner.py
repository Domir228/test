...
class Runner (BoxLayout):
    ...
    finished = BooleanProperty(False) # и сделаны ли все перемещения
    def __init__(self,
                total10, steptime1, autorepeat=True,
                bcolor=(0.73, 0.15, 0.96, 1), 
                btext_inprogress='Пpиседание',
                **kwargs):
        ...
        self.btn = Button(size_hint=(1, 8.1), pos_hint={'top': 1.8}, background_color=bcolor) 
